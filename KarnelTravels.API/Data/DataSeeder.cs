    ...
    public static async Task SeedAsync(KarnelTravelsDbContext context)
    {
        ...
        var contacts = new List<Contact>
        {
            new Contact
            {
                ...
                ServiceType = "Tour",
                PreferredDate = DateTime.Now.AddDays(14),
                NumberOfPeople = 4,
                Message = "Tôi muốn được tư vấn về tour Hạ Long 3 ngày 2 đêm cho 4 người vào dịp cuối tuần sau.",
            ...
            new Contact
            {
                ...
                ServiceType = "Hotel",
                NumberOfPeople = 2,
                Message = "Tôi muốn đặt phòng Deluxe tại InterContinental Hanoi Westlake vào ngày 20/3.",
            ...
            new Contact
            {
                ...
                Message = "Tôi rất hài lòng với dịch vụ của Karnel Travels. Cảm ơn đội ngũ đã tổ chức chuyến đi tuyệt vời!",
