...
const RestaurantCard = ({ restaurant }) => {
  ...
  const handleFavoriteClick = async (e) => {
    ...
    try {
      if (isFavorite) {
        await favoriteService.removeByItem('Restaurant', restaurant.restaurantId);
      } else {
        await favoriteService.addFavorite('Restaurant', restaurant.restaurantId);
      }
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-gray-400 text-sm">({restaurant.reviewCount || 0} reviews)</span>
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-teal-600 to-cyan-700 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-white/80">Discover local cuisine</p>
        </div>
      </div>
