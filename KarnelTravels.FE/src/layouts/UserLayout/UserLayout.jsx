          ...
          <div className="flex items-center justify-between">
                ...
                <div key={item.path} className="relative">
                  {item.hasDropdown ? (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2.5 rounded-lg font-medium text-gray-700 hover:bg-teal-50 hover:text-teal-600 transition-all"
                    >
                      {item.name}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="lg:hidden p-2.5 rounded-lg bg-gray-100 text-gray-700 transition-all"
              >
